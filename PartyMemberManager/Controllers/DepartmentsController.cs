...
{
    public class DepartmentsController : PartyMemberControllerBase
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Password,SchoolAreas,Id,CreateTime,OperatorId,Ordinal,IsDeleted")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Password,SchoolAreas,Id,CreateTime,OperatorId,Ordinal,IsDeleted")] Department department)
        {
            if (id != department.Id)
            {
                return NotFoundData();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    Department departmentInDb = await _context.Departments.FindAsync(id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Save([Bind("Name,Password,SchoolAreas,Id,CreateTime,OperatorId,Ordinal,IsDeleted")] Department department)
        {
