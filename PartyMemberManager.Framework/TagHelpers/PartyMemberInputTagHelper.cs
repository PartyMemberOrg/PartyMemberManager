...
//using PartyMemberManager.Framework.Properties;
...
namespace ERASSystem.Web.Framework.TagHelpers
{
    /// <summary>
    /// <see cref="ITagHelper"/> implementation targeting &lt;input&gt; elements with an <c>asp-for</c> attribute.
    /// </summary>
    [HtmlTargetElement("erasinput", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class PartyMemberInputTagHelper : TagHelper
    {
        ...
        public PartyMemberInputTagHelper(IHtmlGenerator generator)
        {
            Generator = generator;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.PreElement.SetHtmlContent("<div class='col-md-8'>");
            ...
            IDictionary<string, object> htmlAttributes)
        {
            ...
            if (true) // (ViewContext.CheckBoxHiddenInputRenderMode != CheckBoxHiddenInputRenderMode.None)
            {
            ...
            IDictionary<string, object> htmlAttributes)
        {
            ...
            if (string.IsNullOrEmpty(format))
            {
                    ...
                    (modelExplorer.Model is DateTime || modelExplorer.Model is DateTimeOffset))
                {
                    ...
                    modelExplorer = modelExplorer.GetExplorerForModel(modelExplorer);
                }
                else
                {
