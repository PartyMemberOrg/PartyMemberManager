...
namespace PartyMemberManager.Framework.TagHelpers
{
    ...
    public class PartyMemberEditorTagHelper : TagHelper
    {
        ...
        public PartyMemberEditorTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //var templateBuilder = new TemplateBinder(
            //    viewEngine,
            //    bufferScope,
